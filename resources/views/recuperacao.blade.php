    ...
    <div class="container">
        <div class="form-container">
            ...
            <form action="#">
                ...
                <button type="submit" class="submit-btn" href="../codigo por e-mail/index.html">Enviar Link de Recuperação </button> 
                
            </form>
             <p class="login-link"> <a href="">Voltar para o Login</a></p>
        </div>
    </div>
</body>
</html>